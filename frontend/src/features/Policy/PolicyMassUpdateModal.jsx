...
const PolicyMassUpdateModal = ({ isOpen, fields, onClose, onUpdate }) => {
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Select a field and enter the value to update multiple policy records.
          </DialogDescription>
        </DialogHeader>
...
export default PolicyMassUpdateModal;

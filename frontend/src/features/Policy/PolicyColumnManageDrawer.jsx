...
const PolicyColumnManageDrawer = ({ isOpen, visibleColumns, allColumns, onClose, onColumnsChange }) => {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={onClose} direction="right">
      <DrawerContent>
        <DrawerHeader>
          <DrawerTitle>Manage Policy Columns</DrawerTitle>
          <DrawerDescription>
            Select which columns to display in the policy table.
          </DrawerDescription>
        </DrawerHeader>
        <div className="px-4">
          <Input

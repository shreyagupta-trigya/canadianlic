...
const MassUpdateModal = ({ isOpen, fields, onClose, onUpdate, selectedOfferings }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Mass Update Offerings</DialogTitle>
          <DialogDescription>
            Select a field and enter the value to update multiple offerings.
          </DialogDescription>
        </DialogHeader>

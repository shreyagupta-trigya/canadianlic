...
const FamilyTreeForm = ({ formData, setFormData, isDisabled , handlePrevious, handleNext }) => {
  ...
  // Effect to sync dependentParentsData with numberOfDependentParents
  useEffect(() => {
    const num = parseInt(safeFormData.numberOfDependentParents) || 0;
    setDependentParentsData(prev => {
      const currentLength = prev.length;
      if (currentLength < num) {
        return [...prev, ...Array(num - currentLength).fill({ relationship: "", name: "", dob: "", email: "", phone: "", age: "" })];
      } else if (currentLength > num) {
        return prev.slice(0, num);
      }
      return prev;
    });
  }, [safeFormData.numberOfDependentParents]);

  // Effect to sync dependentChildrenData with numberOfDependentChildren
  useEffect(() => {
    const num = parseInt(safeFormData.numberOfDependentChildren) || 0;
    setDependentChildrenData(prev => {
      const currentLength = prev.length;
      if (currentLength < num) {
        return [...prev, ...Array(num - currentLength).fill({ relationship: "", name: "", dob: "", email: "", phone: "", age: "" })];
      } else if (currentLength > num) {
  ...
  }, [safeFormData.numberOfDependentChildren]);

  // Effect to sync siblingData with numberOfSiblings
  useEffect(() => {
    const num = parseInt(safeFormData.numberOfSiblings) || 0;
    setSiblingData(prev => {
      const currentLength = prev.length;
      if (currentLength < num) {
        return [...prev, ...Array(num - currentLength).fill({ relationship: "", name: "", dob: "", email: "", phone: "", age: "" })];
      ...
      <div className="space-y-4">
        ...
        {safeFormData.dependentParents === 'Yes' && dependentParentsData.length > 0 && (
          <div className="overflow-x-auto">
            ...
            <Button onClick={addRowToDependentParentsData} disabled={isDisabled} className="bg-blue-500 hover:bg-blue-600">
              Add Row
            </Button>
          </div>
        )}
...
<SelectTrigger className={"w-86"}>
        ...
        {safeFormData.dependentChildren === 'Yes' && dependentChildrenData.length > 0 && (
          <div className="overflow-x-auto">
            ...
            <Button onClick={addRowToDependentChildrenData} disabled={isDisabled} className={"bg-blue-500 hover:bg-blue-600"}>
              Add Row
            </Button>
          </div>
        )}
      ...
      <div className="space-y-4">
        ...
        {safeFormData.siblings === 'Yes' && siblingData.length > 0 && (
          <div className="overflow-x-auto">
            ...
            <Button onClick={addRowToSiblingData} disabled={isDisabled} className={"bg-blue-500 hover:bg-blue-600"}>
              Add Row
            </Button>
          </div>
        )}
      ...
      <div className="space-y-4">
        ...
        <div className="overflow-x-auto">
          ...
          <Button onClick={addRowToEmergencyContact} disabled={isDisabled} className={"bg-blue-500 hover:bg-blue-600"}>
            Add Row
          </Button>
        </div>
      </div>

...
const MassUpdateModal = ({ isOpen, fields, onClose, onUpdate, selectedRows }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Mass Update Partner Contacts</DialogTitle>
          <DialogDescription>
            Select a field and enter the value to update multiple partner contacts.
          </DialogDescription>
        </DialogHeader>

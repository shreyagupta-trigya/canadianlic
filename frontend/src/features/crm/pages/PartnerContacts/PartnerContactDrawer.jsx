...
const PartnerContactDrawer = ({ isOpen, onClose, onSearchResults }) => {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={onClose} direction="right">
      <DrawerContent width="22%">
        <DrawerHeader>
          <DrawerTitle>Filter Partner Contacts</DrawerTitle>
          <DrawerDescription>Search and filter partner contacts</DrawerDescription>
        </DrawerHeader>
        <div className="px-4">
          <Input
...
export default PartnerContactDrawer;

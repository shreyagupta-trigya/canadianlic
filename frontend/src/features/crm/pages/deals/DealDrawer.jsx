...
const layoutOptions = ["Client", "Advisor"];
...
const allFields = [
  ...
  { label: 'Stage', model: 'stage', placeholder: 'Stage', type: 'array', options: stageOptions },
  { label: 'Layout', model: 'layoutName', placeholder: 'Layout', type: 'array', options: layoutOptions },
  ...
  { label: 'Insurance Lookup', model: 'insuranceLookup', placeholder: 'Insurance Lookup', type: 'text' },
];

const DealDrawer = ({ isOpen, onClose, onSearchResults }) => {
    ...
    <Drawer open={isOpen} onOpenChange={onClose} direction="right">
      <DrawerContent>
        <DrawerHeader>
          ...
          <DrawerDescription>Search and filter deals</DrawerDescription>
        </DrawerHeader>
        <div className="px-4">
          <Input

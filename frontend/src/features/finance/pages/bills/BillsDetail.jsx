        ...
        <div className="flex border  w-full rounded-none">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem>Create Vendor Credits</DropdownMenuItem>
                        ...
                        <tbody>
                          {billData.map((item, i) => (
                            <tr key={i} className="border-b hover:bg-gray-50">
                              ...
                              <td className="p-2 text-green-600 font-medium"></td>
          ...
          {!showPDF && (
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 px-20 py-4 border-t gap-12">
                {/* Left Section */}
                <div className="space-y-4">
                  <h3 className="text-2xl font-normal">BILL</h3>
                  <p className="text-sm">
                    Receive#{" "}
              ...
              <Card className="w-full border-none shadow-none px-20 py-4">
                <CardContent className="px-0">
                  {/* Table Header */}
                  <div className="grid grid-cols-6 gap-12 font-medium text-gray-500 text-[10px] px-4 py-2 border-b">
                    <div>#</div>
                  ...
                  {/* Table Row */}
                  <div className="grid grid-cols-6 gap-6 items-start py-4 border-b text-sm">
                  ...
                  {/* Second Row Example */}
                  <div className="grid grid-cols-6 gap-6 items-start py-4 border-b text-sm">
                    <div className="text-[13px] text-gray-600 pl-4">2</div>
                    <div className="col-span-2 flex gap-3">
                      <img
                        src="https://res.cloudinary.com/dxwlavykb/image/upload/v1751520655/199db57cb1094f079c53ad3c0168e0fc_uj8d3b.jpg"
                        alt="item"
                      ...
                      <div>
                        <div className="text-blue-600 font-medium hover:underline cursor-pointer">
                          HNF363R HDSS NF 3P3W 600V 100A N3R
                        </div>
                        <div className="text-[13px] text-gray-500">
                          SKU: SIEHNF363R
                        </div>
                        <div className="text-[13px] text-gray-500">HNF363R</div>
                      </div>
                    </div>
                    <div className="text-[13px] pl-4">
                      1 <span className="text-[13px] text-gray-500">pc</span>
                  ...
                  <div className="flex flex-col items-end py-4 px-4 gap-2 text-sm">
                    <div className="flex justify-between w-full max-w-xs">
                      ...
                      <span className="font-bold">$838.00</span>
                    </div>
          ...
          {showPDF && (
            <div>
                ...
                <CardContent className="p-6 space-y-4 text-sm text-gray-700">
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right space-y-1">
                      <p className=" text-[2.4rem]">BILL</p>
              ...
              {/* <div className="flex justify-evenly mt-5">
                <p> Ion Lighting Stock Warehouse</p>
                <div>
                  <p>PDF Template : 'Standard Template' <span className="text-blue-400">Change</span></p>

...
const allFields = [
  { label: "Vendor Name", model: "userFirstName", placeholder: "Vendor Name", type: "text" },
  { label: "Vendor Type", model: "contactFirstName", placeholder: "Vendor Type", type: "text" },
  { label: "Email", model: "email", placeholder: "Email Address", type: "text" },
  { label: "Vendor Owner", model: "contactLastName", placeholder: "Vendor Owner", type: "text" },
  { label: "Vendor Status", model: "vendorStatus", placeholder: "Vendor Status", type: "text" },
...
const VendorSearchDrawer = ({ isOpen, onClose, onSearchResults }) => {
  ...
  const handleCheckboxChange = (model, checked) => {
    ...
    if (checked) {
      setOperationForm((prev) => ({
        ...prev,
        [model]: getOperationOptions(allFields.find((f) => f.model === model))[0]?.value || "",
      }));
    } else {
    ...
    <Drawer open={isOpen} onOpenChange={onClose} direction="right">
      <DrawerContent width="22%">
        <DrawerHeader>
          ...
          <DrawerDescription>Search and filter vendors</DrawerDescription>
        </DrawerHeader>
        <div className="px-4">
          <Input
        ...
        <DrawerFooter>
          <div className="flex gap-2 justify-center">
            <Button className="text-white" variant="primary" onClick={searchVendors}>
              Search
            </Button>

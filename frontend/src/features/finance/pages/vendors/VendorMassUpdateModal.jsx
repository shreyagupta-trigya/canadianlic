...
const VendorMassUpdateModal = ({ isOpen, fields, onClose, onUpdate, selectedVendors }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Mass Update Vendors</DialogTitle>
          <DialogDescription>
            Select a field and enter the value to update multiple vendors.
          </DialogDescription>
        </DialogHeader>
...
export default VendorMassUpdateModal;

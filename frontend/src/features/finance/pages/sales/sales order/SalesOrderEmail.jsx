...
Ion Electrical Distributor<br />
  ...
  return (
    <div className="w-full max-w-4xl border rounded-md p-4 bg-white shadow-sm text-sm">
      <table className="w-full table-fixed border-separate border-spacing-y-1">
        <tbody>
          <tr className="align-top">
            ...
            <td>jamie &lt;jamie@ionlighting.com&gt;</td>
          </tr>
          ...
          <tr className="align-top">
            ...
            <td className="w-full">
              <input
                ...
                defaultValue="Sales Order from Ion Electrical Distributor (Sales Order #: ION-SO-22-2037)"
              />
            </td>
          </tr>
        </tbody>
      </table>
      <div className=" border rounded shadow min-h-75 bg-white my-5 ml-20 p-2 ">
        <ReactQuill
          value={value}

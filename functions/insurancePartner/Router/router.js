...
const {testConnection,create_insurancepartner,updateInsurancepartner,deleteInsurancepartner,getinsurancePartnerList,getinsurancePartnerbyid} = require("../controller/controller");
...
// **************** VENDOR FUNCTIONS ******************
const { testVendorConnection,createVendor } = require("../controller/vendorController");

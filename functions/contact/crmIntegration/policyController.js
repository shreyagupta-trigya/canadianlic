...
async function policyDetailsParseData(formData){
  return {
    Application_Submitted_On: formData?.leadInfo?.applicationSubmittedOn??null,
    Application_Follow_Up_Date: formData?.leadInfo?.nextFollowUpDate??null,
    New_Policy_Start_Date: formData?.leadInfo?.newPolicyStartDate??null,
    Application_Date: formData?.leadInfo?.applicationInitiatedOn??null,
    Policy_Approved_Date: formData?.leadInfo?.policyApprovedDate??null,
    Cancellation_Amendment_Requested_for: formData?.leadInfo?.cancellation??"",
    Policy_Attachment_Link: formData?.leadInfo?.policyAttachmentLink??"",
    Re_Name_of_Confirmation: formData?.leadInfo?.nameOfConfirmationRenewal??"",
    Policy_Start_Date: formData?.leadInfo?.policyStartDate??"",
    Policy_Issued_Date: formData?.leadInfo?.policyIssuedDate??null,
    Policy_Expiry_On: formData?.leadInfo?.policyExpiresOn??null,
    Name_of_Confirmation: formData?.leadInfo?.nameOfConfirmation??"",
    Policy_Picked_Up_On: formData?.leadInfo?.policyPickedUpOn??"",
    Application_Postponed_To: formData?.leadInfo?.applicationPostponedTo??null,
    Policy_Declined_Date: formData?.leadInfo?.policyDeclineDate??null,
    Amendment_Requested_Date: formData?.leadInfo?.earlyReturnAmendmentRequested??null,
    Amendment_Completed_Date: formData?.leadInfo?.earlyReturnAmendmentCompletedDate??null,
    Application_Cancelled: formData?.leadInfo?.earlyReturnApplicationCancelled??null,
    Policy_Renewal_Date: formData?.leadInfo?.policyRenewalDate??null,
    Policy_Review_Comments_updated_on: formData?.leadInfo?.policyReviewCommentUpdatedOn??null,
    Comments_on_Rejection: formData?.leadInfo?.reasonForPolicyBeingDeclined??"",
    Amendment_Requested_for: formData?.leadInfo?.earlyReturnAmendmentRequestedFor??"",
    Policy_Review_Comments: formData?.leadInfo?.policyReviewComments??"",
    Confirmation_Poilcy_Renewal_Expired: formData?.leadInfo?.renwalExpired??"",
    Premiums_Paid: formData?.leadInfo?.premiumPaidDuringPickUpPeriod??"",
    Is_Medical_required: formData?.leadInfo?.applicationMedicalRequirement??"",
    Confirmation_Policy_Start: formData?.leadInfo?.confirmationPolicyStart??"",
    Renewal_Medical_requested: formData?.leadInfo?.renewalMedicalRequirement??"",
    Is_Policy_Renewed: formData?.leadInfo?.policyRenewalCompleted??"",
  }
}

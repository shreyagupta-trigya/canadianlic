...
const {connectionCheck,getAllInsurencePartner,createNewLead,getLeadById,getAllLeads,getLeads,getAllContact,deleteLead,updateLead,getAllLocations,getAllAdvisor,getAllUsers,leadConvert} = require("../Controller/controller");
...
const {testcredential,getAllAdvisorCredentialById, getAllAdvisorCredential,addAdvisorCredential,updateAdvisorCredential,deleteAdvisorCredential} = require("../Controller/advisorCrd");
...
const {getTableInstance,getAllTabels} = require("../Controller/getTableInstance");

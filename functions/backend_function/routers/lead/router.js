...
const {test,getLeadById,getAllLeads,getLeads,deleteLead,leadConvert, leadRelatedData,downloadFile} = require("../../controller/lead/leadController");
const { getUsers, getAdviors, getLocations, getContacts, getLeadData, getReferral,getSingleData,createNewLead,updateNewLead,testUat } = require("../../controller/lead/leadController");
...
//crediental form
const {testcredential, getAllAdvisorCredential,addAdvisorCredential,updateAdvisorCredential,deleteAdvisorCredential} = require("../../controller/lead/leadController");
...
// const { lifetest, createNewRecord, deleteDeals } = require("../../controller/lead/leadController");

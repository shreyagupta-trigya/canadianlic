...
const { decryptData } = require("../../Utils/productFunction/utils");
const searchQueryBuilder = require("../../Utils/productFunction/searchQueryBuilder");
const { createObjectCsvStringifier } = require("csv-writer");
const { getSequence, updateSequence } = require("../../Utils/productFunction/sequenceUtils");
const { offering, sample } = require("../../exports/productFunction/exports");
...
const {
  generateToken,
  createOffering
} = require("../../Utils/productFunction/crmIntegration/offeringDataSyncController");
...
exports.updateProduct = async (req, res) => {
  try {
    ...
    res.status(409).json({ success: false, message: "Updated Failed", output: error });
  }
};

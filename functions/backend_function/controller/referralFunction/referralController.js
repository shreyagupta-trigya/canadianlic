...
const searchQueryBuilder = require("../../Utils/referralFunction/searchQueryBuilder");
const {
  insertMultipleRowsIntoTable,
  deleteById,
  decryptData,
} = require("../../Utils/referralFunction/utils");
...
exports.getSingleReferral = async (req, res) => {
...
exports.sendEmailSample = async (req, res) => {
...
exports.approveReferralEmail = async (req, res) => {
...
exports.getReferralRegister = async (req, res) => {
...
exports.updateRegisterReferral = async (req, res) => {
  console.log(req.params.id);
  const referral = req.body;
  const mainformData = {
    referralName: referral.referralName,

...
const { decryptData } = require("../../Utils/advisorFunction/utils");
const searchQueryBuilder = require("../../Utils/advisorFunction/searchQueryBuilder");
const NodeCache = require( "node-cache" );
const { createObjectCsvStringifier } = require("csv-writer"); 
const Node = new NodeCache();
const {advisor, advisorSample} = require("../../exports/advisorFunction/exports");

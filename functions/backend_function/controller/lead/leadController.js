...
async function parseContactData(formData, festival,module) {
  return {
    ...
    eligibleRoundRobinOwnerFound: formData?.eligibleRoundRobinOwnerFound ?? false,
    ...
    areYouReadyToPurchaseThisLifeInsurancePoli: formData?.areYouReadyToPurchaseThisLifeInsurancePoli ?? "",
    ...
    phoneBurnerFollowUpDate: new Date(formData?.phoneBurnerFollowUpDate) ?? null,
...
async function parseDescription(description, leadId) {
  return {
    ...
    preExistingmedicaLconditions: description?.preExistingmedicaLconditions ?? "",
    howMuchCoverageIsRequired: description?.howMuchCoverageIsRequired ?? "",
    canYouPleaseLetMeKnowPremiumPaymentMode: description?.canYouPleaseLetMeKnowPremiumPaymentMode ?? "",
    tobaccoused: description?.tobaccoused ?? "",
    whatTypeOfTermPlanAreYouLookingFor: description?.whatTypeOfTermPlanAreYouLookingFor ?? "",
    doYouWantCriticalIllnessInsuranceWithMoney: description?.doYouWantCriticalIllnessInsuranceWithMoney ?? "",
    howDoYouConsiderYourHealth: description?.howDoYouConsiderYourHealth ?? "",
    whatsYourProfession: description?.whatsYourProfession ?? "",
    howManyCriticalIllnessCoverageYouNeed: description?.howManyCriticalIllnessCoverageYouNeed ?? "",
    howMuchMonthlyBenefitDoYouNeed: description?.howMuchMonthlyBenefitDoYouNeed ?? "",
    selectTheDurationOfTheCoverage: description?.selectTheDurationOfTheCoverage ?? "",
    youAreSeekingCoverageFor: description?.youAreSeekingCoverageFor ?? "",
    enterTheAmountOfMortgageCoverageRequired: description?.enterTheAmountOfMortgageCoverageRequired ?? "",
    whatsYourAge: description?.whatsYourAge ?? "",
    doYouHaveAnyMedicalIssue: description?.doYouHaveAnyMedicalIssue ?? "",
    secureYourChildsFutureWithHigherEducation: description?.secureYourChildsFutureWithHigherEducation ?? "",
    howMuchDoYouWantToSaveMonthly: description?.howMuchDoYouWantToSaveMonthly ?? "",
    wouldLikeToIncreaseMonthlyDeposits: description?.wouldLikeToIncreaseMonthlyDeposits ?? "",
    howManyChildrensDoYouHave: description?.howManyChildrensDoYouHave ?? "",
    eligibleToGetExtra2000InGovernmentGrants: description?.eligibleToGetExtra2000InGovernmentGrants ?? null,
    whatIsYourResidencyStatusInCanada: description?.whatIsYourResidencyStatusInCanada ?? "",
    depositEveryMonthTowardsYourChildEducation: description?.depositEveryMonthTowardsYourChildEducation ?? "",
    howLongDoYouNeedCoverageFor: description?.howLongDoYouNeedCoverageFor ?? "",
    wouldYouLikeToKnowHowRespWorks: description?.wouldYouLikeToKnowHowRespWorks ?? "",
    moneyRequireToCompleteYourChildEducation: description?.moneyRequireToCompleteYourChildEducation ?? "",
    selectYourAgeBracket: description?.selectYourAgeBracket ?? "",
    oneMillionInanRespAccountAtRetirement: description?.oneMillionInanRespAccountAtRetirement ?? "",
    howMuchdoYouWantToSaveYearly: description?.howMuchdoYouWantToSaveYearly ?? "",
    doYouWanToDepositMonthlyOrYearlyPremium: description?.doYouWanToDepositMonthlyOrYearlyPremium ?? "",
    wouldYouLikeToKnowHowTfsaWorks: description?.wouldYouLikeToKnowHowTfsaWorks ?? "",
    whatageDoYouWanttostartTheWithdrawalFrom: description?.whatageDoYouWanttostartTheWithdrawalFrom ?? "",
    whatKindOfBusinesssIsIt: description?.whatKindOfBusinesssIsIt ?? "",
    wouldYouLikeToKnowHowRrspWorks: description?.wouldYouLikeToKnowHowRrspWorks ?? "",
    oneMillionInAnTfsaAccountAtRetirement: description?.oneMillionInAnTfsaAccountAtRetirement ?? "",
    areYouAnOwnerOrEmployeeOfTheBusiness: description?.areYouAnOwnerOrEmployeeOfTheBusiness ?? "",
    areYouLookingForDrugAndDentalOrJustDrugPla: description?.areYouLookingForDrugAndDentalOrJustDrugPla ?? "",
    areYouLicensedAsAnInsuranceAdvisor: description?.areYouLicensedAsAnInsuranceAdvisor ?? "",
    whatTimeFrameYouLikeToMoveToBeaAdvisor: description?.whatTimeFrameYouLikeToMoveToBeaAdvisor ?? "",
    wouldYouLikeToKnowHowSuperVisaInsuranceWo: description?.wouldYouLikeToKnowHowSuperVisaInsuranceWo ?? "",
    ...
    secureYourChildFutureWithHigherEducation: description?.secureYourChildFutureWithHigherEducation ?? "",
    enterageOf2ndTraveler: description?.enterageOf2ndTraveler ?? "",
...
async function parseSerce(services, umtDetail, leadId) {
  return {
    ...
    combinationOrHybridInsurance: services?.combinationOrHybridInsurance ?? "false",
...
async function parseAdvisorData(leadData, facebookData, refferelData) {
  let advisorLead = {
    ifReferredByAdvisorOrExternalReferral: leadData?.ifReferredByAdvisorOrExternalReferral ?? "",
    existingPolicyRenewalDueBy: leadData?.existingPolicyRenewalDueBy ?? "",
    rcSmsOptOut: leadData?.rcSmsOptOut ?? false,
...
async function downloadFile(type) {
  try {
    let headers = type == "advisor" ? leadadvisor : type == "sample" ? sample : leadclient;
    const csvStringifier = createObjectCsvStringifier({
      header: headers,
    });
    const data = type == "advisor" ? advisorGenerate : type == "sample" ? sampleData : clientGenerate;
  ...
  function compareObjects(o1, o2, path) {
    for (let key in o2) {
      if (o2.hasOwnProperty(key)) {
        ...
        } else if (typeof o2[key] === "object" && !Array.isArray(o2[key]) && o2[key] !== null) {

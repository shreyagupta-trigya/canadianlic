...
exports.updateDataInTable = async (catalystApp, tableName, data) => {
  try {
    const result = await catalystApp
      .datastore()
      .table(tableName)
...
exports.filterContactData=async (contactData,viewAll,viewOnly)=>{
      console.log("This is a contact data",contactData,viewAll,viewOnly);
      return contactData;
}

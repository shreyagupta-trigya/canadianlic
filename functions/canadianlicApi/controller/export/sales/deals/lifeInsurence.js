...
module.exports = [
  ...
  {
    id: "Referred", // not matched with frontend --->in db as referredBy
    title: "Referred by",
  },
  {
    id: "house", // not matched with frontend --->in db as doYouOwnAHouseinCanada
  ...
  {
    id: "ref", // not matched with frontend --->in db as ifreferredbyAdvisor
  ...
  {
    id: "eligibleOwner", //not matched with vfrontend -->in db as eligibleRoundRobinOwnerFound
  ...
  {
    id: "number", //not matched with fromtend-->as numberOfInsured
    title: "Number of insured",
  },
  //start subform of dealData
  {
    id: "dealOwner", //Insured Name,Insured Phone,Insured Email
    title: "Deal Owner",
  },
  //end subform of dealData
  ...
  {
    id: "arethereMultipleBeneficiariesexclClient",
  ...
  },
  {
    ...
    id: "religion", //not in db
    title: "Religion",
  },
  {
    id: "celebratedFestivals", //not in db
    title: "Celebrated Festivals",
  },
  //start subform of festivalsData
  {
  ...
  {
    id: "netCorporateCommisionAfterDeductibles", //duplicate id --> need to be changed at frontend
  ...
  {
    id: "potentialBusinessPolicyValues", //not in db

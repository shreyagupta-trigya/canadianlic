...
module.exports = [
  ...
  {
    id: "advisorProbhitedBehaviourCompliance", //not in db
  ...
  {
    id: "advisorBonusLevel",
    title: "Advisor Bonus level",
  },
  {
    id: "advisorCodeOfConductComplaince", //not in db
  ...
  //subform of Is Client the Insured?
  {
    id: "isClientTheInsured",
    title: "Is Client the Insured?", //Insured Name,	Insured Date Of Birth,	Insured Email,	InsuredPhone,	Relationship of Insured with client
  },
  {
  ...
  {
    id: "policyAttachmentLink", //not in db

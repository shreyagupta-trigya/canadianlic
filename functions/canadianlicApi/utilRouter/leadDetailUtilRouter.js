...
const { createNotes, getNotes, deleteNotes, getSingleNote, updateNote } = require("../controller/utilsApis/controllersNotes");
...
// Routes
router.post("/create-notes", upload.array("files"), createNotes);
...
//********* Remote Access ************/
const {testRemoteAccess, createRemoteAccess,updateRemoteAccess,deleteRemoteAccess,getCount, getallRemoteAccess } = require("../controller/utilsApis/remoteAccessController");

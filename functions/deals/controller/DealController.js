...
const queries = require("../query/DealQuery");
...
const {standard,critical,rrsp,lifeInsurance,standardData,lifeInsurenceData,rrspData,criticalInsurenceData} = require("../exports");
// ***************** CRM CFUNCTION *********************
const {generateToken, dataSyncZcrm} = require("../crmIntegration/crmIntegrationController");

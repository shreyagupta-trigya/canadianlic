<template>
        ...
        <div class='row ps-2'>
          <div class="col-lg-4 col-md-4 col-sm-12 mt-3">
            <div class="d-flex justify-content-start align-items-center">
              <label class="my-0 mx-2">Update Family Tree</label>
              <input
                v-model="formData.updateFamilyTree"
                type="checkbox"
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 mt-3">
            <div class="d-flex justify-content-start align-items-center">
              <label class="my-0 mx-2">Update Family Tree for Supervisa</label>
              <input
                v-model="formData.updateFamilyTreeforSupervisa"
                type="checkbox"
                class="form-check-input border"
              />
            </div>
      ...
      <div style="width: 100%; overflow: scroll">
        <table class="table border table-responsive subform">
          ...
          <tbody class="table-group-divider">
            <tr
              v-for="(parent, index) in emergencyContactData"
              :key="index"
            >
              <td class="m-auto">{{ index + 1 }}</td>
              ...
              <td>
                <input
                  v-model="parent.emergencyContactName"
                  type="text"
                  class="form-control form-control-default"
                  isrequired="false"
                  autocomplete="off"
              ...
              <td>
                <input
                  v-model="parent.emergencyContactPhone"
                  type="text"
                  class="form-control form-control-default"
                  isrequired="false"
                  autocomplete="off"
              ...
              <td>
                <input
                  v-model="parent.emergencyContactRelationship"
                  type="text"
                  class="form-control form-control-default"
                  isrequired="false"
                  autocomplete="off"
              ...
              <td>
                <input
                  v-model="parent.emergencyContactEmail"
                  type="text"
                  class="form-control form-control-default"
                  isrequired="false"
                  autocomplete="off"
      ...
      <button
        class="btn mb-0 btn-color btn-md null null"
        type="button"
        @click.prevent="addRowToEmergencyContact">
        Add Row
      </button> 
    </div>
...
export default {
    ...
    methods: {      
      addRowTosiblingData()  {
        ...
        previousStep() {
        this.$emit('previous',{...this.formData, siblingData:this.siblingData,  dependentChildrenData: this.dependentChildrenData, dependentParentsData: this.dependentParentsData, emergencyContactData: this.emergencyContactData });
        }
    }
};
</script>

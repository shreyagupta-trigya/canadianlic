  ...
  methods: {
    ...
    async handleSubmit() {
      ...
      if(this.route.params.id){
        await axios.post(`${putUrl}deals/api/v1/update-standrard-deal/${this.route.params.id}`, this.apiData)
        .then((response) => {
          Swal.fire({
        ...
        await axios.put(`${putUrl}deals/api/v1/create-standrard-deal`, this.apiData)
        .then((response) => {
          Swal.fire({
            timer: 2000,

<template>
  <div>
    ...
    <h5 class="main-heading mb-0">Deal Info</h5>
    <div>
      ...
      <div class="row mt-3">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
          ...
          <SingleSlelect class="form-select " id="dealOwner" v-model="formData.dealOwner"
          :options="ownersArr" />
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12">
          ...
          <!-- <input v-model="formData.insuranceLeadLookup" type="text" class="form-control form-control-default" /> -->
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12">

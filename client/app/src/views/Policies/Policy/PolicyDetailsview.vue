<template>
  <div
    class="contactView no-scroll card me-2 mb-0 pb-0"
    style="border-radius: 5px; max-height: 89vh"
  >
    <!-- navbar strats here -->
    <nav
      :class="[mobileView ? 'col px-0' : 'row px-2']"
      class="col-12 pb-0 pt-3 border-bottom"
    >
      ...
      <div v-if="!mobileView" class="col-12 d-flex justify-content-between">
        <div class="col-6">
          ...
          >
          <a
            :class="{ selected: selectedTab === 'Notes' }"
            @click="selectTab('Notes')"
            class="mx-2 text-md position-relative"
            href="javascript:;"
            >Notes
            <span
          ...
          >
          <a
            :class="{ selected: selectedTab === 'Communication' }"
            @click="selectTab('Communication')"
            class="text-md mx-1 position-relative"
            href="javascript:;"
            >Comms
            <span
          ...
          <a
            :class="{ selected: selectedTab === 'OpenActivity' }"
            @click="selectTab('OpenActivity')"
            class="text-md mx-1"
            href="javascript:;"
            >Open Activity</a
          >
          <a
            :class="{ selected: selectedTab === 'CloseActivity' }"
            @click="selectTab('CloseActivity')"
            class="text-md mx-1"
            href="javascript:;"
            >Closed Activity</a
          >
          ...
          <!-- <a
            :class="{ selected: selectedTab === 'ZohoSurvey' }"
            @click="selectTab('ZohoSurvey')"
            class="text-md mx-1 position-relative"
            href="javascript:;"
            >ZohoSurvey
          </a> -->
            ...
            <li>
              <a class="dropdown-item" @click="changeNav('ZohoSurvey')">Zoho Survey
              </a>
            </li>
          </ul>
        </div>
        ...
        >
          <div style="position: relative">
            ...
            <ul
              class="dropdown-menu dropdown-menu-start dropdown-menu-lg-start"
              style="
                border: 1px solid;
                max-height: 300px;
                position: absolute;
            ...
            >
              ...
              <div class="search-container-div" style="padding: 10px;width:100%">
      ...
      <div
        :class="{ 'mobile-view-navbar-open': navVisible }"
      ...
      >
        <ul class="mt-3">
          <li>
            <a
              @click="selectTab('Overview')"
              class="text-md px-1 mx-2 col-12"
              href="javascript:;"
              >Overview</a
            >
          </li>
          ...
          <li>
            <a
              @click="selectTab('Notes'), toggleActivityNav()"
              class="mx-2 text-md px-1"
              href="javascript:;"
            >
              Notes</a
            >
          ...
          <li>
            <a
              @click="selectTab('Attachments'), toggleActivityNav()"
              class="mx-2 text-md px-1"
              href="javascript:;"
            >
              Attachments</a
          ...
          <li>
            <a
              @click="selectTab('Communication'), toggleCommunicationNav()"
              class="mx-2 text-md px-1"
              href="javascript:;"
            >
              Comms <i class="fa fa-chevron-down mx-2 text-sm"></i
            ></a>
            ...
            <ul v-if="selectedTab === 'Communication'" class="sub-nav">
              <li>
                <a
                  ...
                  @click="selectActionTab('Whatsapp')"
                  class="text-md px-2 text-sm"
                  href="javascript:;"
                >
                  Whats App</a
                >
    ...
    <div class="" v-if="selectedTab === 'Communication' && !mobileView">
      ...
      <div class="row mt-3">
        ...
        <div v-if="selectedActionTab === 'Email'" class="col-2">
          <a href="javascript:;">
            <button class="add-btn btn py-1 mb-0">Send Email</button>
          </a>
        </div>
      </div>
      <!-- button div ends-->
      <nav
        class="border-bottom d-flex justify-content-start text-end p-2 pb-0 pt-3 ms-3"
      >
        <div class="d-flex">
          <div class="position-relative mx-1">
            ...
            <a
              :class="{ selected: selectedActionTab === 'Whatsapp' }"
              @click="selectActionTab('Whatsapp')"
              class="mx-2 text-md px-2"
              href="javascript:;"
              >Whats App</a
            >
          </div>
          ...
          <div class="position-relative mx-1">
            ...
            <a
              :class="{ selected: selectedActionTab === 'SMS' }"
              @click="selectActionTab('SMS')"
              class="text-md mx-2 px-2"
              href="javascript:;"
              >SMS</a
            >
          </div>
          ...
          <div class="position-relative mx-1">
            ...
            <a
              :class="{ selected: selectedActionTab === 'Email' }"
              @click="selectActionTab('Email')"
              class="text-md mx-2 px-2"
              href="javascript:;"
              >Email</a
    ...
    <div class="card-body custom-scroll pt-2" style="min-height: 72vh">
      ...
      <div
        ...
        class="mb-5 row justify-content-center conatct-overview"
      >
        <Overview />
      </div>
      <!-- part overview 1  -->
      <div
        v-if="selectedTab === 'Overview'"
        class="d-none mb-5 row justify-content-center conatct-overview"
      >
          ...
          <div class="row">
            ...
            <div class="d-flex pt-1 col-lg-6 col-md-6 col-sm-12">
              <div class="overview-img text-center">
                <span class="overview-img-text pt-2">PA</span>
              </div>
              <div class="mt-4">
                <p class="mb-0 heading-color overview-heading text-bold">
                  {{ userName }}
                </p>
                <p :class="mobileView ? 'text-sm' : 'text-lg'">Policies</p>
                <div>
                  <i
                    :class="[
                      mobileView ? 'text-sm' : 'fs-4',
                      'fa',
                      'fa-whatsapp',
                      'cursor-pointer',
                      'pe-3',
            ...
            <div class="me-5 mt-4 mb-2 col-lg-4 col-md-3 col-sm-12">
              ...
              <div class="text-start heading-color">
                <section class="d-flex">
                  <div class="pt-1 px-3">
                    <i class="fa fa-mobile text-color"></i>
                  </div>
                  <div>
              ...
              <div class="text-start heading-color">
                <section class="d-flex">
                  <div class="pt-1 px-3">
                    <i class="fa fa-street-view text-color"></i>
                  </div>
                  <div>
        ...
        <div class="row mt-4 justify-content-center ps-0 pe-0">
          ...
          >
            <div class="card p-3 h-100">
              ...
              <section class="d-flex">
                <div class="pt-1 px-3">
                  <i class="fa fa-birthday-cake text-color"></i>
                </div>
                <div>
        ...
        <div v-if="!mobileView" class="mt-4 container card">
          <div class="ms-2 container pt-2">
            ...
            <p class="mb-0 text-sm heading-color">
          ...
          <div class="col pt-2 mt-4 container pb-3">
            ...
            <section v-if="!mobileView" class="d-flex col-8 border p-2 mb-3">
              ...
              <div class="col-8">
                ...
                <p class="text-sm text-muted">
                  Recieve notification directly on my screen
                </p>
              </div>
              <button class="col-2 desktop-notifications py-1 btn mt-2 mx-2">
                Enable
              </button>
            </section>
            ...
            <section
              v-if="!mobileView"
              class="d-flex justify-content-between col-8 border p-2"
            >
              <div class="d-flex">
      ...
      <div class="User-Offerings-section border">
        <div>
          ...
          <div class="User-Offerings-content pt-2">
            ...
            <div
              class="User-headings d-flex justify-content-between mx-3 cursor-pointer"
      ...
      <div
        v-if="selectedActionTab === 'Whatsapp'"
        class="null-data-image-div"
      ...
      <div v-if="selectedTab === 'OpenActivity'">
        <OpenActivity :id="this.id"/>
      </div>
      <!-- CloseActivity ends here- -->
      <!-- CloseActivity starts here- -->
      <div v-if="selectedTab === 'CloseActivity'">
        <CloseActivity />
      </div>
      <!-- CloseActivity ends here- -->

      <!-- ZohoSurvey starts here- -->
      <div v-if="selectedTab === 'ZohoSurvey'">
        <ZohoSurvey />
      </div>
...
import Overview from "./Policyform.vue";
    ...
    async getPolicies() {
      try {
        const response = await axios.get(
          `${putUrl}Policy/api/v1/getpolicy/${this.id}`
        );
       const data = response?.data?.policyData?.[0] ?? null;
        console.log("policies in details view", response);
        this.userName = data.userData.firstName + " " + data.userData.lastName;
      } catch (error) {
        console.log(error);
      }
    },

<template>
    <div class="card-body">
      <h5 class="main-heading mb-2 ps-2">Family Tree</h5>
       <div class="card-surface">

      <div class="multisteps-form__content">
        <!-- Family Tree Form -->
        <div class="row mt-2 p-2">
          <div class="col-lg-4 col-md-4 col-sm-6 mt-2 mt-sm-0">
      ...
      <!-- Emergency Contact Form -->
        <div class="card-surface mt-3 ps-2">
      <div class="multisteps-form__content mt-3">
        <h5 class="main-heading mb-2 ps-2">
    ...
    <div class="button-row d-flex justify-content-center mt-4 gap-4 space">
      <button
        class="btn mb-2 bg-gradient-light btn-md null null js-btn-prev"
        type="button"
        @click="previousStep"
      >
        Prev

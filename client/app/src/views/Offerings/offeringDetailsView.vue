<template>
    <div class="contactView no-scroll  card me-2 mb-0 pb-0" style="border-radius: 5px; max-height: 89vh; ">
        ...
        <nav :class="[mobileView ? 'col px-0' : 'row px-2']" class=" col-12   pb-0 pt-3 border-bottom">
            ...
            <div v-if="!mobileView" class="col-12 d-flex justify-content-between ">
                ...
                <a :class="{ 'selected': selectedTab === 'Deals' }" @click="selectTab('Deals')"
                    class="text-md  mx-1 " href="javascript:;">Deals</a>
                 <a :class="{ 'selected': selectedTab === 'ClientOffering' }" @click="selectTab('ClientOffering')"
                    class="text-md  mx-1 " href="javascript:;">Client Offering</a>
  ...
  <ul class="dropdown-menu dropdown-menu-start dropdown-menu-lg-start"  style="border: 1px solid; max-height:200px; top:19px; position:absolute; overflow-y:auto;left:-157px;">
    <div class="search-container-div col-lg-12 col-md-10 col-sm-12">
      ...
      <li v-for="(item, index) in filteredItems" :key="index">
        ...
        <div class="card-body custom-scroll pt-2" style="min-height:72vh">
                    ...
                    <div class="row">
                        ...
                        <div class=" d-flex pt-1 col-lg-6 col-md-6 col-sm-12">
                            <div class="overview-img text-center "> <span class="overview-img-text pt-2"> {{
                                (offeringsData.user.firstName
                                    != (null || undefined)) ? offeringsData.user.firstName.slice(0, 1).toUpperCase() +
                                offeringsData.user.lastName.slice(0, 1).toUpperCase() : '' }}</span></div>
                            <div class=" mt-4 ">

                                <p class="mb-0 heading-color overview-heading text-bold">{{ offeringsData.user.firstName
                                    + ' ' + offeringsData.user.lastName }}</p>
                                <p :class="mobileView ? 'text-sm' : 'text-lg'">Offerings</p>
                                <div>
                            ...
                            <div class="text-start heading-color">
                                <section class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-muted">{{ offeringsData.user.email }}</p>
                                    </div>
                            ...
                            <div class="text-start heading-color">
                                <section class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-muted">{{ offeringsData.user.phone }}</p>
                                    </div>
                            ...
                            <div class="text-start heading-color">
                                <section class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-muted">{{ offeringsData.user.city }}</p>
                                    </div>
            ...
            <!-- deals ends here- -->
              ...
              <!--ClientOffering  starts here- -->
              <div v-if = "selectedTab === 'ClientOffering'">
                 <ClientOffering/>
             </div>
            <!-- ClientOffering ends here- -->
...
import Deals from "../utils/commonRelatedList/deals/deals.vue";
import ClientOffering from "../utils/commonRelatedList/clentOffering/ClientOffering.vue";
...
export default {
    ...
    data() {
        ...
        ' zoho sign',
        ' zoho show time',
        ' zoho bookings for CRM',
        ' zoho assist for CRM',
        ' Advanced round robin lead assignment',
        ' multi user ringcentral  sms messaging',
        ' phoneburner extension for zoho crm',
        ' zoho pageSense',
        ' Kanban board'
    ...
    methods: {
        async getAllOfferings() {
            console.log(this.id)
            try {
                const response = await axios.get(`${putUrl}Policy/get-single-offerings/${this.id}`)
                console.log({ response })
                this.offeringsData.user = response.data.response[0].userData
            } catch (error) {
                console.log(error)
            }
        },

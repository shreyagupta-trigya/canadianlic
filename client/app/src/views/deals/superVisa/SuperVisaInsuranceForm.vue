<template>
  ...
  <script>
// <<<<<<< SUPERVISA INSURANCE COMPONENT >>>>>>
  import LifeInsurance from './superVisaComponent/LifeInsurance.vue';
  import DealOwnership from './superVisaComponent/DealOwnership.vue';
  import PolicyTracking from './superVisaComponent/PolicyTracking.vue';
  import PolicyReview from './superVisaComponent/PolicyReview.vue';
  import Claims from './superVisaComponent/Claims.vue';
  import ApplicationCal from './superVisaComponent/ApplicationCal.vue';
  import FamilyTree from './superVisaComponent/FamilyTree.vue';
  import Festivals from './superVisaComponent/FestivalForm.vue';
  import Facebook from './superVisaComponent/Facebook.vue';
  import Address from './superVisaComponent/AddressInformation.vue'
  import LeadMgmt from './superVisaComponent/LeadMgmt.vue';
   ...
   data(){
    const route = useRoute();
      ...
      apiData: {
        ...
        familyTree:[],
        leadMgmt:{},
        layout: "Supervisa Insurance",
      }
      }
    },
      methods: {
      async fetchInitialData(id) {
      console.log("<<<<<<<<====== SUPERVISA DETAILS ======>>>>>>>>>>", id);
      try {
        this.isLoading = true;
        ...
        console.log("================================================================", this.apiData.dealOwnership );

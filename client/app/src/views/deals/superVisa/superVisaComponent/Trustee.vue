<template>
    <div>
            ...
            <table class="table border table-responsive subform">
                ...
                <tbody class="table-group-divider">
                    <tr v-for="(parent, index) in formData.trusteeData" :key="index">
                        ...
                        <td>
                            <input v-model="parent.nameOfTrustee" type="text" class="form-control form-control-default"
                                autocomplete="off">
                        </td>
                        <td>
        ...
        <button class="btn mb-0 btn-color btn-md" type="button" @click.prevent="addRowTotrusteeTable">
            Add Row
        </button>
    </div>
</template>

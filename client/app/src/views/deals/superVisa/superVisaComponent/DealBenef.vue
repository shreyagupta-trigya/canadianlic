    ...
    <div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
                ...
                <input v-model="formData.numberofBeneficiariesupto4" type="text"
            ...
            <table class="table border table-responsive subform">
                ...
                <tbody class="table-group-divider">
                    <tr v-for="(beneficiary, index) in formData.beneficiariesData" :key="index">
                        ...
                        <td>
                            <input v-model="beneficiary.beneficiaryName" type="text" class="form-control form-control-default"
                                autocomplete="off">
                        </td>
                        <td>
...
export default {
    ...
    setup() {
        ...
        function addRowTodealbeneficiaryTable() {

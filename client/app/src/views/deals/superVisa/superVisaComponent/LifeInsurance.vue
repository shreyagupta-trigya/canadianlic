<template>
  <div class="ps-2">
    ...
    <h5 class="main-heading mb-0">Deal Information</h5>
    <div>
     ...
     <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
      ...
      <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
        ...
        <select class="form-select" id="contactOwner" v-model="formData.contactName">
          <option value="" disabled selected class="text-muted">Select Contact</option>
          <option
      ...
      <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
       ...
       <div class="col-lg-4 mt-2 col-md-4 col-sm-12 mt-md-4">
        <label class="my-0 mt-md-2">Next Follow Up Date & Time</label>
        <input v-model="formData.nextFollowUpDateTime" type="datetime-local" class="form-control">
      </div>
        <!--Round Robin Assignment Time -->
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
       <div>
      <label class="my-0" for="roundRobinAssignmentTime">Round Robin Assignment Time </label>
      <input type="datetime-local" class="form-control border" id="roundRobinAssignmentTime" v-model="formData.roundRobinAssignmentTime" />
      </div>
    </div>
    <div class="col-lg-4 mt-2 col-md-4 col-sm-12 mt-md-4">
        <label class="my-0 mt-md-2">Understanding of insurance</label>
  ...
  <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
        <label class="my-0">Gender Prediction</label>
      ...
      <div class="col-lg-4 mt-2 col-md-4 col-sm-12 mt-md-4">
        <label class="my-0 mt-md-2">Referred by</label>
  ...
  <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
        <label class="my-0">GenderPredictionScore</label>
  ...
  <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
    ...
    <div class="col-lg-4 mt-2 col-md-4 col-sm-12 mt-md-4">
        <label class="my-0 mt-md-2">Assigned Advisor</label>
        <input v-model="formData.assignedAdvisor" type="text" class="form-control form-control-default" />
      </div>
    <div class="col-lg-4 mt-2 col-md-4 col-sm-12 mt-md-4">
    <label class="my-0 mt-md-2" for="leadCreatedOn">LeadCreatedOn</label>
  ...
  <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
        ...
        <input v-model="formData.netWorth" type="text" class="form-control form-control-default" />
      </div>  
  <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
  ...
  <textarea id="assignedCampaigns" v-model="formData.assignedCampaigns" class="form-control"></textarea>
</div>
<div class="col-lg-4 mt-2 col-md-4 col-sm-12">
  ...
  <div class="col-lg-4 mt-2 col-md-4 col-sm-12 mt-md-4">
  <label class="my-0 mt-md-2" >Preferred Contact Time</label>
  <input type="text" v-model="formData.preferredContactTime" class="form-control" />
    ...
    <div class="col-lg-4 mt-2 col-md-4 col-sm-12 mt-md-4">
      ...
      <select class="form-select" id="reassignment" v-model="formData.reassignment">
        <option value="" disabled selected class="text-muted">Lead Source</option>

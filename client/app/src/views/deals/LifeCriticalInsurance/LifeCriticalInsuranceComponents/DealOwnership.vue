<template>
  <div>
    <h5 class="main-heading mt-2 ps-2">Deal Owner</h5>
    ...
    <div class="col-lg-4 col-md-6 col-sm-4 mt-sm-0">   
      ...
      <input  type="text" v-model="formData.numberOfInsured" class="form-control " >   
    </div>
  </div>    
...
<!-- Beneficiarie sub for -->
  <div class="mt-3">
    <div>
      ...
      <div class="row mb-2 ps-2">
          <div class="col-lg-4 col-sm-6 mt-2 mt-md--3 mt-sm-0">
  ...
  watch: {
    DealOwnership: {
      handler() {
        ...
        // console.log("dealOwnership=======>",this.dealOwnership);
        this.trusteeData = this.DealOwnership.trusteeData || [];
        // console.log("testee=======>",this.trusteeData);

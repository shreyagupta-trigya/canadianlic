    ...
    <div>
      ...
      <div class="row ps-2">
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          ...
          <SingleSlelect class="form-select " id="dealOwnerOptions" v-model="formData.dealOwner" :options="ownersArr" />
          <!-- <select
            class="form-select"
            id="dealOwnerOptions"
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          ...
          <select v-model="formData.insuranceLeadSource" class="form-select">
            <option v-for="(option, index) in insuranceLead" :key="index" :value="option">
              {{ option }}
            </option>
          </select>
        </div>
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          ...
          <select class="form-select" id="leadOwner" v-model="formData.insuranceLeadLookup">
            <option value="" disabled selected class="text-muted">Select Lead Lookup</option>
        ...
        <!--insurance Lead -->
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Insurance Lead</label>
          <select class="form-select" id="leadOwner" v-model="formData.insuranceLead">
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          ...
          <input v-model="formData.exchangeRate" type="number" disabled class="form-control form-control-default" />
        </div>

        <!--PhoneBurner Follow Up Date -->
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Next Follow Up Date & Time</label>
          <input v-model="formData.phoneBurnerFollowUpDate" type="datetime-local" class="form-control">
        </div>
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          ...
          <!-- standard form name is stage -->
          <input v-model="formData.stage" type="text" class="form-control form-control-default" />
        </div>
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Gender Predicition</label>
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          ...
          <input v-model="formData.doYouOwnAHouseinCanada" type="text" class="form-control form-control-default" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Social Media Information</label>
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Gender Prediction Score</label>
          <input v-model="formData.genderPredictionScore" type="number" class="form-control form-control-default" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Is This a Reassignment ?</label>
          <input v-model="formData.reassignment" type="text" class="form-control form-control-default" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0" for="emailIsValid">If referred by Advisor or External Referral - Name</label>
          <input type="text" id="emailIsValid" v-model="formData.ifreferredbyAdvisor" class="form-control" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Assigned Advisor</label>
          <input v-model="formData.assignedAdvisor" type="text" class="form-control form-control-default" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0" for="leadCreatedOn">Lead Created On</label>
          <input type="date" id="leadCreatedOn" v-model="formData.leadCreatedOn" class="form-control" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Insurance Lead Status</label>
          <input v-model="formData.insuranceLeadStatus" type="text" class="form-control form-control-default" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0">Net Worth</label>
          <input v-model="formData.netWorth" type="number" class="form-control form-control-default" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <label class="my-0" for="submitPageURL">Submit Page URL</label>
          <input type="url" id="submitPageURL" v-model="formData.submitPageURL" class="form-control" />
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
      ...
      <div class="col-lg-6 mt-2 col-md-6 col-sm-12 ps-2">
        <label class="my-0" for="assignedCampaigns">Assigned Campaigns</label>
        <textarea id="assignedCampaigns" rows="4" v-model="formData.assignedCampaigns" class="form-control"></textarea>
      </div>
      <div class="row mt-1">
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <div class="d-flex justify-content-start align-items-center mt-2">
            <label class="my-0 mx-2" for="eligibleRoundRobinOwnerFound">Eligible Round Robin Owner Found</label>
            <input type="checkbox" class="form-check-input border" id="eligibleRoundRobinOwnerFound"
        ...
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <div class="d-flex justify-content-start align-items-center mt-2">
            ...
            <input type="checkbox" class="form-check-input border" id="rcSmsOptOut" v-model="formData.rcSmsOptOut" style="width: 16px; height: 16px;" />
          </div>
        </div>
        <div class="col-lg-4 mt-2 col-md-4 col-sm-12">
          <div class="d-flex justify-content-start align-items-center mt-2">
            <label class="my-0 mx-2" for="emailOutput">EmailOutput</label>
            <input type="checkbox" class="form-check-input border" id="emailOutput" v-model="formData.emailOutput" style="width: 16px; height: 16px;"  />
          </div>
        </div>
      </div>
    </div>

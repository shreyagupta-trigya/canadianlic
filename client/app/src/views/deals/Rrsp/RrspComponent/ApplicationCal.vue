  ...
  <div class="ps-2">
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12">
        ...
        <input v-model="formData.totalPolicyCommission" type="number"  placeholder="" class="form-control form-control-default" />
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12">
        <label class="my-0">Total Advisor Commission</label>
        <input v-model="formData.totalAdvisorCommission" type="number" placeholder="" class="form-control form-control-default" />
      </div>
       </div>
    <div class="row mt-3">
      <div class="col-lg-4 col-md-4 col-sm-12 mt-md-4">
        <label class="my-0">Net Corporate Commission</label>
        <input v-model="formData.netCorporateCommission" type="number" placeholder="" class="form-control form-control-default" />
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12 mt-lg-4">
        <label class="my-0">Actual Policy Commission After Deductibles</label>
        <input v-model="formData.actualPolicyCommissionAfterDeductibles" placeholder="" type="number" class="form-control form-control-default" />
      </div>
      <div class="col-lg-4 col-md-4 col-sm-12 mt-md-4">
        <label class="my-0">Return Amount</label>
        <input v-model="formData.returnAmount" type="number" placeholder="" class="form-control form-control-default" />
      </div>
    </div>
    <div class="row mt-3"> 
      <div class="col-lg-4 col-md-4 col-sm-12">
        <label class="my-0">Net Advisor Commission After Deductible</label>
        <input v-model="formData.netAdvisorCommissionAfterDeductible" placeholder="" type="number" class="form-control form-control-default" />
      </div> 
      <div class="col-lg-4 col-md-4 col-sm-12">
        <label class="my-0">Net Corporate Commission After Deductibles</label>
        <input v-model="formData.netCorporateCommissionAfterDeductible" type="number" placeholder="" class="form-control form-control-default" />
      </div>     
  </div>

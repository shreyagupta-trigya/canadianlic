<template>
    <div>
      <h5 class="main-heading mt-2 ps-2">Deal Trustee</h5>
        ...
        <table class="table border table-responsive subform">
          ...
          <tbody class="table-group-divider">
            <tr v-for="(parent, index) in subform" :key="index">
              ...
              <td>
                <input
                  v-model="parent.nameOfBeneficiaryForTrustee"
                  type="text"
                  class="form-control form-control-default"
                  autocomplete="off"
                />
              ...
              <td>
                <input
                  v-model="parent.relationshipWithBeneficiaryForTrustee"
                  type="text"
                  class="form-control form-control-default"
                  autocomplete="off"
                />

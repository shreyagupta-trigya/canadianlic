<template>
  <div class="contactView no-scroll  card me-2 mb-0 pb-0" style="border-radius: 5px; max-height: 89vh; ">
    ...
    <nav :class="[mobileView ? 'col px-0' : 'row px-2']" class=" col-12   pb-0 pt-3 border-bottom">
      ...
      <div v-if="!mobileView" class="col-10 ">
      ...
      <!-- navbar to show in mobile -->      
        <div :class="{ 'mobile-view-navbar-open' : navVisible }" class="mobile-view-navbar left-0 top-14 position-absolute h-100 bg-white border responsive-text-size">
          <ul class="mt-3">
            <li>
    ...
    <div class="card-body custom-scroll pt-2" style="min-height:72vh">
      ...
      <div v-if="selectedTab === 'overview'" class="d-none mb-5 row justify-content-center conatct-overview">
        <div class="card col-lg-12 col-md-12 col-sm-12 gap-5">
          <div class="row">
            ...
            <div class=" d-flex pt-1 col-lg-6 col-md-6 col-sm-12">
              <div class="overview-img text-center "> <span class="overview-img-text pt-2">{{ this.refferalData.referralName != (null ||undefined) ? this.refferalData.referralName.slice(0,1) :''  }}</span></div>
              <div class=" mt-4 ">

                <p class="mb-0 heading-color overview-heading text-bold">{{ this.refferalData.referralName }}</p>
                <p :class="mobileView ? 'text-sm' : 'text-lg'">Refferal</p>
                <div>
              ...
              <div class="text-start heading-color">
                <section class="d-flex">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-muted">{{ this.refferalData.email  }}</p>
                  </div>
              ...
              <div class="text-start heading-color">
                <section class="d-flex">
                  ...
                  <div>
                    ...
                    <p class="text-xs text-muted">{{ this.refferalData.phone }}</p>
                  </div>
        ...
        <div class=" row mt-4 justify-content-center ps-0 pe-0">
          <div :class="{' min-h-50 ' : mobileView}" class=" heading-color col-md-6 col-sm-12 ps-0 remove-padding-in-mobile skype-div">
...
import Overview from "./AddRefferal.vue"
...
export default {
  ...
  methods: {
    ...
    try {
        const response = await axios.get(`${putUrl}referralFunction/getsinglereferral/${this.id}`);
        const refferalDetail = response.data.mainData.map((item) => item.referralData);
        this.refferalData = refferalDetail[0];
    } catch (error) {
